...
export default function VerifyPhone() {
  ...
  const handleVerifyCode = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        // Refresh session to get updated user with phone
        await checkSession();
        // Use the response data or refetched user type for routing
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center pb-4">
          ...
          <h1 className="text-2xl font-display font-semibold">Verify Your Phone</h1>
          <CardDescription>
            {step === 'phone' 
              ? "We'll send you a text to verify your number for pickup notifications"
